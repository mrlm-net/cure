...
func TestCopilotInstructionsCommand_NonInteractive(t *testing.T) {
	tmpDir := t.TempDir()
	outputPath := filepath.Join(tmpDir, ".github", "copilot-instructions.md")
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			cmd := &CopilotInstructionsCommand{}
			fset := cmd.Flags()
...
func TestCopilotInstructionsCommand_DryRun(t *testing.T) {
	tmpDir := t.TempDir()
	outputPath := filepath.Join(tmpDir, ".github", "copilot-instructions.md")
...
func TestCopilotInstructionsCommand_CreatesParentDir(t *testing.T) {
	tmpDir := t.TempDir()
	// Use a deeply nested path — directory should be auto-created
	outputPath := filepath.Join(tmpDir, "subdir", ".github", "copilot-instructions.md")
...
func BenchmarkCopilotInstructionsCommand_DryRun(b *testing.B) {
	var stdout, stderr bytes.Buffer
	tc := &terminal.Context{Stdout: &stdout, Stderr: &stderr, Config: nil}
